...
class ApacheMavenScraper:
    ...
    def list_version_files(self, version, return_unmatched_urls=False):
        ...
        for version in versions:
            ...
            version_url = urlparse.urljoin(self.starting_url, 'maven-' + major_version + '/' + version + '/')
            urls_to_parse.append(version_url)
            urls_to_parse.append(urlparse.urljoin(version_url, 'binaries/'))
            urls_to_parse.append(urlparse.urljoin(version_url, 'sources/'))
